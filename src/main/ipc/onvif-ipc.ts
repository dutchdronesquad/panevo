...
export const registerOnvifIpc = (): void => {
  ...
  ipcMain.handle(
    ...
    async (_event, input: OnvifProbeInput): Promise<PanevoResult<OnvifProbeResult>> => {
  ...
  ipcMain.handle(
    ...
    async (_event, input?: OnvifDiscoveryInput): Promise<PanevoResult<OnvifDiscoveryResult[]>> => {
